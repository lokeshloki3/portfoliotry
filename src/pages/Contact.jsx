...
export default function Component() {
  ...
  <div className="flex items-center gap-1.5">
    <svg className="h-5 w-5 shrink-0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 25" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="text-right">
    <a className="inline-flex items-center justify-center gap-2 rounded bg-white px-3 py-2 text-center text-sm leading-none text-dark transition after:absolute after:inset-0 after:h-full after:w-full after:content-[''] hover:bg-light hover:text-primary dark:bg-dark dark:text-light/70 dark:hover:bg-dark-2 dark:hover:text-primary">
      ...
      <svg className="h-3.5 w-3.5 shrink-0" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 14 15" xmlns="http://www.w3.org/2000/svg">
