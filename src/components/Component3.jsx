...
export default function Component3() {
  return (
    <>
      <div
        id="mobile-menu"
        className="-translate-x-full [&::-webkit-scrollbar-thumb]:bg-gray-300 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar]:w-2 bg-white bottom-0 dark:bg-dark duration-300 fixed h-full hs-overlay hs-overlay-open:translate-x-0 overflow-y-auto start-0 top-0 transform transition-all w-64 z-[60] open"
        style={{
          borderWidth: "0px",
          borderStyle: "solid",
          ...
          width: "16rem",
          transform:
            "translate(0px,0) rotate(0) skew(0) skewY(0) scaleX(1) scaleY(1)",
          overflowY: "auto",
